    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-100 px-4 py-1.5 text-sm font-semibold text-indigo-600 dark:border-indigo-500/20 dark:bg-indigo-500/20 dark:text-indigo-300">
            <FaUser />
            Profile
          </div>

          <h1 className="mt-4 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-4xl font-bold text-transparent dark:from-white dark:to-slate-300">
            My Profile
          </h1>
        ...
        <Link
          to="/profile/edit"
          className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-5 py-3 font-medium text-white shadow-lg transition hover:scale-105"
        >
          <FaEdit />
          Edit Profile
        </Link>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-between border-b border-gray-200 pb-4 dark:border-slate-700">
